...
[[nodiscard]] TextWithEntities UnsupportedMessageText() {
	const auto siteLink = u"https://t.me/AshugramReleases"_q;
	auto result = TextWithEntities{
		tr::lng_message_unsupported(tr::now, lt_link, siteLink).replace("Telegram", "Ashu")
	};
...
HistoryMessageMarkupData UnsupportedMessageMarkup() {
	...
	row.emplace_back(
		Button::Type::Url,
		tr::lng_update_telegram(tr::now).replace("Telegram", "Ashu"),
		Button::Visual(),
		QByteArray("https://t.me/AshugramReleases"));
