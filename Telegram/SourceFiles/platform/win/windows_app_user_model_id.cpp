...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Ashu.AshuDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Ashu.AshuDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Ashu.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Ashu Desktop/Ashu.lnk"_q;
	const auto old = u"Ashu for Windows/Ashu.lnk"_q;
