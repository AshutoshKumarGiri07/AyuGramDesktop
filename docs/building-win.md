...
The default modern toolset from Visual Studio 2026 (`v145`) does not support Windows 7, so for Ashugram Desktop you must use `-vcvars_ver=14.44` (`v144.4`, based on `v143` with Windows 7 support).
...
In the initialized terminal, go to ***BuildPath*** and run
    ...
    git clone --recursive https://github.com/AshutoshKumarGiri07/AyuGramDesktop.git tdesktop
...
* The result Ashugram.exe will be located in **D:\TBuild\tdesktop\out\Debug** (and **Release**)
